<template>
  <div class="card col-12 col-sm-6 col-md-2 p-0 me-4 mb-3 rounded" style="min-width:350px !important; min-height: 550px;">
    <!--Header-->
    <div class="card-header person-header d-flex flex-column pt-3 pe-3 ps-3">
      ...
      <h4 class="align-self-start flex-shrink-1 text-white mt-4">Name</h4>
    </div>
    <!--End Header-->
    <div class="card-body">
      <!--Body Header-->
